# In payroll_manager/migrations/0001_initial.py

# This is the clean version of your initial migration file.
# It only creates the database schema and does NOT populate data.
